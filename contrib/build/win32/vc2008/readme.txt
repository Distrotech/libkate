MSVC 2008 build files

Contributed by Roman Vorobets
---

In order to build liboggkate, encoder and decoder (both example and tools), you
will need to compile libogg first (available at http://www.xiph.org).
For the encoder tool, you will also need to compile zlib (available at
