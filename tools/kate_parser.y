...
kd_def: LANGUAGE STRING { kate_info_set_language(&ki,$2); }
      | CATEGORY STRING { kate_info_set_category(&ki,$2); }
      | DIRECTIONALITY directionality { kate_info_set_text_directionality(&ki,$2); }
